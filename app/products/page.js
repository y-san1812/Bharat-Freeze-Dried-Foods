...
export const metadata = {
  ...
  description: 'Explore 200+ freeze-dried products: fruits, vegetables, precooked Indian foods, gravies, spices, superfoods, and vegetarian pet nutrition.',
};
...
export default function ProductsPage() {
  return (
    <main>
      ...
      {/* Compact Video Hero — matches About page height with entrance animations */}
      <section
        style={{
          position: 'relative',
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 10, paddingLeft: 'max(20px, 4vw)', maxWidth: '840px' }}>
          ...
          <p className="hero-p-anim" style={{
            ...
            Premium freeze-dried products across 7 categories — fruits, vegetables, precooked meals, spices, superfoods, and more.
          </p>
        </div>
