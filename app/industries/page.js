...
export const metadata = {
  title: 'Industries — Bharat Freeze Dried Foods | Sectors We Serve',
  description: 'BFF serves restaurants, hotels, retail, pet food, wellness, and export industries with premium freeze-dried ingredients. Explore our sector-specific solutions.',
};
...
export default function IndustriesPage() {
  return (
    <main>
      ...
      {/* Compact Video Hero — matches About page height */}
      <section
        style={{
          position: 'relative',
      ...
      >
        ...
        >
          <source src="/videos/industries_bg.mp4" type="video/mp4" />
        </video>
        ...
        <div style={{ position: 'relative', zIndex: 10, paddingLeft: 'max(20px, 4vw)', maxWidth: '840px' }}>
          ...
          <p className="hero-p-anim" style={{
            ...
            Trusted by businesses across hospitality, retail, manufacturing, wellness, exports, and more.
          </p>

          <div className="hero-btns-anim" style={{ display: 'flex', flexWrap: 'wrap', gap: '14px' }}>
            <a href="#sectors" className="btn btn-primary">Explore Sectors</a>
          </div>
        </div>
