...
export const metadata = {
  title: "Export — Bharat Freeze Dried Foods | India's Freshness Delivered Worldwide",
  description: 'Export-ready freeze-dried foods shipped to 30+ countries. FSSAI, ISO 22000, APEDA certified. No cold chain required.',
};
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 10, paddingLeft: 'max(20px, 4vw)', maxWidth: '840px' }}>
          ...
          <p className="hero-p-anim" style={{
            ...
            India&apos;s freshness, delivered to global markets. Zero cold chain, 5-year shelf life, premium quality logistics.
          </p>

          <div className="hero-btns-anim" style={{ display: 'flex', flexWrap: 'wrap', gap: '14px' }}>
            <a href="#map" className="btn btn-primary">Explore Global Sourcing</a>
          </div>
        </div>
