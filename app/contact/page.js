...
export const metadata = {
  title: 'Contact — Bharat Freeze Dried Foods | Get in Touch',
  description: 'Send an inquiry to BFF. Get a quote for freeze-dried products, private label manufacturing, or export solutions. We respond within 24 hours.',
};
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 10, paddingLeft: 'max(20px, 4vw)', maxWidth: '840px' }}>
          ...
          <p className="hero-p-anim" style={{
            ...
            color: 'rgba(255,255,255,0.70)', maxWidth: '600px',
          }}>
